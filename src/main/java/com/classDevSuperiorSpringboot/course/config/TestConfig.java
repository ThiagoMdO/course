...
import com.classDevSuperiorSpringboot.course.model.entities.*;
import com.classDevSuperiorSpringboot.course.model.enums.OrderStatus;
import com.classDevSuperiorSpringboot.course.repositories.*;
...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Order o1 = new Order(null, Instant.parse("2020-03-22T12:30:55Z"), OrderStatus.PAID, u1);
        ...
        Payment pay1 = new Payment(null, Instant.parse("2020-03-22T14:30:01Z"), o1);
        o1.setPayment(pay1);
