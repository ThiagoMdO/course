...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Order o1 = new Order(null, Instant.parse("2020-03-22T12:30:55Z"), u1);
        Order o2 = new Order(null, Instant.parse("2021-03-22T12:30:55Z"), u1);
        Order o3 = new Order(null, Instant.parse("2019-03-03T12:40:55Z"), u2);
        Order o4 = new Order(null, Instant.parse("2020-03-22T13:40:55Z"), u2);
